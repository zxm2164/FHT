...
modded 12.20.14 - removed saved registers from clobber list (uncertain if this is
the right thing to do, but it fixes a compiler error for r28/r29)
*/
...
static inline void fht_run(void) {
  ...
  : "r18", "r19", "r20", "r21", "r22", "r23", "r24", "r25",
   "r26", "r27", "r30", "r31" // clobber list for whole thing (non call-saved)
  );
...
static inline void fht_reorder(void) {
  ...
  : :
  : "r20", "r26", "r27", "r30", "r31" // clobber list (non call-saved)
  );
...
static inline void fht_mag_log(void) {
  ...
  "9: \n" // all done
  : :
  : "r26", "r27", "r30", "r31", "r18", "r19", "r20" // clobber list (non call-saved)
  );
...
static inline void fht_window(void) {
  ...
  "brne 1b \n"
  : :
  : "r20", "r30", "r31", "r22", "r23" // clobber list (non call-saved)
  );
...
static inline void fht_mag_octave(void) {
  ...
  "rjmp 10b \n"
  : :
  : "r26", "r27", "r30", "r31", "r18", "r19", "r20", "r21", "r22" // clobber list (non call-saved)
  );
